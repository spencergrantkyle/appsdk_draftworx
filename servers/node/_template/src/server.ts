...
<link rel="stylesheet" href="https://persistent.oaistatic.com/ecosystem-built-assets/example-0038.css">
<script type="module" src="https://persistent.oaistatic.com/ecosystem-built-assets/example-0038.js"></script>
    `.trim(),
    responseText: "Rendered example widget!"
  }
...
// Define Zod parser for runtime validation
...
function createMcpServer(): Server {
  ...
  server.setRequestHandler(CallToolRequestSchema, async (request: CallToolRequest) => {
    ...
    // const result = processToolRequest(args);
    ...
    return {
      ...
      structuredContent: {
        exampleParam: args.exampleParam
      },
      _meta: widgetMeta(widget)
    };
  });
